...
public class Tienda2 {
    ...
    public void anadir(Computadoras Computadora){
    ...
    public static int buscar(String marcaComputadora){
        ...
        for (int i=0;i< computadores.size();i++){
            computador= (Computadoras) computadores.elementAt(i);
    ...
    public void imprimir(){
        for (int i=0;i< computadores.size();i++){
            ...
            Computadoras computador =(Computadoras) computadores.elementAt(i);
